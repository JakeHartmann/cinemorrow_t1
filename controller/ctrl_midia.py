...
Escolha uma opção (criar mídia): """, [1, 2, 3])]()
    ...
    def criar_filme(self):
        ...
        self.__filmes.append(Filme(titulo))
    ...
    def remove_midia(self):
        ...
        if not (self.__filmes or self.__series):
    ...
    def remove_filme(self):
        ...
        validos = list(range(1, len(self.__filmes) + 1)) + [0]
        ...
        if opcao == 0:
            ...
            filme_escolhido = self.__filmes[opcao - 1]
            print(
                f"O filme '{filme_escolhido.titulo}' foi removido com sucesso.")
            self.__filmes.remove(filme_escolhido)
            self.standby()
    ...
    def remove_serie(self):
        ...
        for (i, serie) in enumerate(self.__series, start=1):
            print(f"[{i}] - {serie.titulo}")
            
        print("0 para retornar")
        validos = list(range(1, len(self.__series) + 1)) + [0]
        ...
        if opcao == 0:
            ...
            serie_escolhida = self.__series[opcao - 1]
            print(
                f"A série '{serie_escolhida.titulo}' foi removida com sucesso.")
            self.__series.remove(serie_escolhida)
            self.standby()
    ...
    def lista_midias(self):
        ...
        if self.__series or self.__filmes:
